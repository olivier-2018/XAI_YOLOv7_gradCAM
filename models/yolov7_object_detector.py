...
class YOLOV7TorchObjectDetector(nn.Module):
    def __init__(self,
        ...
        self.names = self.model.names if names == None else names
    ...
    def forward(self, img):
        prediction, logits, _ = self.model(img, augment=False) #  torch.Size([1, 25200, 85]), torch.Size([1, 25200, 80])
...
if __name__ == '__main__':
    ...
    print("[INFO] image preprocessed: ",img.shape)    
    a = model(img)
